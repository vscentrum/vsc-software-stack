...
class Molcas(Interface):
    ...
    def set_cas_variables(self, cas_occupation: List[int]):
        ...
        print(f"XXX-active_orbitals: {self.settings.active_orbitals}")
        print(f"YYY-active_electrons: {self.settings.active_electrons}")
    ...
    def calculate(self, cas_occupation: Optional[List[int]] = None, cas_indices: Optional[List[int]] = None
        ...
        print(f"DEBUG: About to write TYPEINDEX. cas_indices = {cas_indices}")
        print(f"DEBUG: Orbital file = {self.orbital_file}")
